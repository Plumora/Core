...
bech32_templates = [
  ...
  ('plmr',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('plmr',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('plmr',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('plmr',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tplmr',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tplmr',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tplmr',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tplmr',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tplmr',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tplmr',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tplmr',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tplmr',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rplmr',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rplmr',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rplmr',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rplmr', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tplmr',   17, 32, Encoding.BECH32M, False, False, False),
  ('rplmr',  3,  1, Encoding.BECH32M, False, False, False),
  ('plmr',   15, 41, Encoding.BECH32M, False, False, False),
  ('tplmr',    0, 16, Encoding.BECH32,  False, False, False),
  ('rplmr',  0, 32, Encoding.BECH32,  True,  False, False),
  ('plmr',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tplmr',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rplmr',  0, 20, Encoding.BECH32,  False, False, True),
  ('plmr',    0, 20, Encoding.BECH32M, False, False, False),
  ('tplmr',    0, 32, Encoding.BECH32M, False, False, False),
  ('rplmr',  0, 20, Encoding.BECH32M, False, False, False),
  ('plmr',    1, 32, Encoding.BECH32,  False, False, False),
  ('tplmr',    2, 16, Encoding.BECH32,  False, False, False),
  ('rplmr', 16, 20, Encoding.BECH32,  False, False, False),
]
