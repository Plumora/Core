...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " plumora-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  plumora-tx [options] <hex-tx> [commands]  Update hex-encoded plumora transaction\n" +
            "or:     plumora-tx [options] -create [commands]   Create hex-encoded plumora transaction\n" +
            "\n";
