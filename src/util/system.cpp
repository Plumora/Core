...
const char * const BITCOIN_CONF_FILENAME = "plumora.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Plumora";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Plumora";
#else
    // Unix-like
    return pathRet / ".plumora";
#endif
#endif
}
