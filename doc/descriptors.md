# Support for Output Descriptors in Plumora Core

Since Plumora Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `plmr1...` for mainnet or `tplmr1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Plumora Core wallets, a convenience function `combo` is
