...
"""Verify that starting plumora with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start plumora with -h for help text")
        ...
        self.log.info("Start plumora with -version for version information")
        ...
        self.log.info("Start plumorad with -fakearg to make sure it does not start")
