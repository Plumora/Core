Contributing to Plumora Core
============================

The Plumora Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Plumora Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/plumora-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to plumora-qt
...
The following applies to code changes to the Plumora Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Plumora
Network Protocol consensus changes.

Whether a pull request is merged into Plumora Core rests with the project merge
...
Patches that change Plumora consensus rules are considerably more involved than
...
Where a patch set proposes to change the Plumora consensus, it must have been
...
The project leader is the release manager for each Plumora Core release.
